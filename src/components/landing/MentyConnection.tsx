  ...
  return (
    <section className="bg-cream py-20 md:py-28">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <Reveal className="flex flex-col items-center gap-5 rounded-3xl border border-loop-teal/25 bg-white px-6 py-12 text-center shadow-card sm:px-12 md:py-16">
